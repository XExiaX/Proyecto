    ...
    return function (req, res) {
        oracledb.getConnection(constantes.dbPMMC,
            function myFunc(err, connection) {
                ...
                var loginEntrada = {
                    P_BINES: req.body.digitosBines,
                    P_VALIDA: { type: oracledb.STRING, dir: oracledb.BIND_OUT },
                ...
                connection.execute(
                    ...
                    `CALL EINTERFACE.APP_PKG_APP.SP_VAL_BINES(:P_BINES, :P_VALIDA, :P_RESULT, :P_MSG)`,
                    loginEntrada,
                    {
                        maxRows: 1
                    },
